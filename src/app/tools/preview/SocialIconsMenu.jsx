            ...
            <Box display={"flex"} justifyContent={"center"}>
                <Button
                    onClick={handleClick} sx={{
                        ...
                        <IconComp style={{p:1, color: "black", width:"40px", height:"40px"}} />
                </Button>
            </Box>
        </>
    );
...
export default function SocialIconsMenu({toggleIconsMenu, handleToggleSocialIconsMenu, search, handleSearchChange, icons, createSocialIconElement}) {
          ...
          >
            ...
            >
              ...
              <Box m={2} minWidth={"fit-content"}>
                ...
                component="h2"
                textAlign={"center"}>Select a social media icon</Typography>
                        <Box>
                            <Button sx={styles.button2} onClick={handleToggleSocialIconsMenu}>
                ...
                <Box
                    ...
                    <Box
                        ...
                        <Grid
                            ...
                            {icons.length <= 0 ? 
                            <Grid item xs={12}>
                                <Typography textAlign={"center"} m={2} color={"complement.main"}>No icons found</Typography>
                                </Grid> : <></>}
                        </Grid>
                    </Box>
                    </Box>
