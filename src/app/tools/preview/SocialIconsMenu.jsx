...
export default function SocialIconsMenu(props) {
    ...
    return (
        <>
            <Dialog
                open={props.handleToggleSocialIconsMenu}
                TransitionComponent={Transition}
                keepMounted
                onClose={props.handleToggleSocialIconsMenu}
                ...
                <Box
                    ...
                    <DialogTitle
                        ...
                        <Box
                            ...
                            <Button onClick={props.handleToggleSocialIconsMenu}>
                                <motion.svg
                                    fill='black'
                                    width='100'
                                    height='100'
                                ...
                                return (
                                    <Grid key={index} item xs={1}>
                                        <SocialIcon
                                            ...
                                            handleCloseMenu={props.handleToggleSocialIconsMenu}
